...
const { AUTH_STATUS, USER_TYPE, TOKEN_TYPE } = require('../constant')
...
class AuthModel {
  ...
  static async signup(params) {
    ...
    await Email.send({
      email: params.email,
      subject: 'Bulletin Board Signup Confirmation',
  ...
  static async forgetPassword(params) {
    ...
    await Email.send({
      email: params.email,
      subject: 'Bulletin Board Forget Password',
